...
public class ErlangDependenciesResolutionTest extends ModuleTestCase {
  ...
  public void testCyclicDependency() {
    ...
    } catch (ErlangModulesSorter.CyclicDependencyFoundException ignored) {
    }
  }
  ...
  public void testDependenciesAreCompiledFirst() throws Exception {
    ...
    assertSameErlangModules(getStrings(moduleBuildOrder.myOrderedErlangModulePaths), "parse_transform1", "parse_transform2", "behaviour1", "module1");
  }

  public void testTestsDependency() throws Exception {
    ErlangModuleBuildOrderDescriptor moduleBuildOrder = ErlangPrepareDependenciesCompileTask.getModuleBuildOrder(myModule);
    assertSameErlangModules(getStrings(moduleBuildOrder.myOrderedErlangModulePaths), "src_parse_transform");
    assertSameErlangModules(getStrings(moduleBuildOrder.myOrderedErlangTestModulePaths), "test_parse_transform", "test");
  }
  ...
  @NotNull
  private static List<String> getStrings(List<ErlangModuleDescriptor> buildOrder) {
