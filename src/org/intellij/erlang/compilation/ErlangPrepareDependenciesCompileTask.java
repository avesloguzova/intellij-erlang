...
public class ErlangPrepareDependenciesCompileTask implements CompileTask {
  ...
  private static ErlangModuleBuildOrders getModuleBuildOrders(CompileContext context) {
    ...
    } catch (ErlangModulesSorter.CyclicDependencyFoundException e) {
  ...
  @TestOnly
  public static ErlangModuleBuildOrderDescriptor getModuleBuildOrder(Module module) throws ErlangModulesSorter.CyclicDependencyFoundException {
    return getModuleBuildOrderInner(module);
  }

  private static ErlangModuleBuildOrderDescriptor getModuleBuildOrderInner(Module module) throws ErlangModulesSorter.CyclicDependencyFoundException {
  ...
  private static List<ErlangModuleDescriptor> getTopologicallySortedErlangModulePaths(Collection<ErlangFile> erlangModules,
                                                                                           List<String> globalParseTransforms) throws ErlangModulesSorter.CyclicDependencyFoundException {
